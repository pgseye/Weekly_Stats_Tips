...
A somewhat funny example was of Google's AI Overview last year suggesting that an [effective way to make cheese stick to pizza better was to mix in some "non-toxic glue"](https://www.forbes.com/sites/jackkelly/2024/05/31/google-ai-glue-to-pizza-viral-blunders/). The 'training' material in this case was a reddit post by an 11 yr old, but the chatbot used this as a 'valid' source of information. Again, garbage in, garbage out.
...
Allan did eventually come to the realisation that his aspirations for greatness were misplaced, but he only did that by fact-checking his thesis with another chatbot! (Google Gemini). I guess in this case, the destination, rather than the journey, is all that matters...
...
This followed the [tragic case](https://www.theguardian.com/technology/2025/aug/27/chatgpt-scrutiny-family-teen-killed-himself-sue-open-ai) of a 16 yr old Californian teen - Adam Raine - who took his life in April 2025 after months of conversations, comprising up to `650` messages/day, with ChatGPT:
...
OpenAI's systems tracked all of [Adam's interactions](https://www.humanetech.com/podcast/how-openai-s-chatgpt-guided-a-teen-to-his-death "From about the 37 minute mark") (listen from about the `37` minute mark) with ChatGPT and the numbers represent an appalling indictment of OpenAI's safety protocols at the time:
